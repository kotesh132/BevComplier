    ...
    apply {
        if (meta.intrinsic_metadata.deflection_flag == 1w0 && meta.egress_metadata.bypass == 1w0) {
            if (standard_metadata.instance_type != 32w0 && standard_metadata.instance_type != 32w5) {
                process_mirroring.apply(hdr, meta, standard_metadata);
            }
            else {
                process_replication.apply(hdr, meta, standard_metadata);
            }
            switch (egress_port_mapping.apply().action_run) {
                egress_port_type_normal: {
                    if (standard_metadata.instance_type == 32w0 || standard_metadata.instance_type == 32w5) {
                        process_vlan_decap.apply(hdr, meta, standard_metadata);
                    }
                    process_tunnel_decap.apply(hdr, meta, standard_metadata);
                    process_rewrite.apply(hdr, meta, standard_metadata);
                    process_egress_bd.apply(hdr, meta, standard_metadata);
                    process_egress_qos_map.apply(hdr, meta, standard_metadata);
                    process_mac_rewrite.apply(hdr, meta, standard_metadata);
                    process_mtu.apply(hdr, meta, standard_metadata);
                    process_int_insertion.apply(hdr, meta, standard_metadata);
                    process_egress_nat.apply(hdr, meta, standard_metadata);
                    process_egress_bd_stats.apply(hdr, meta, standard_metadata);
                }
            }

            process_egress_l4port.apply(hdr, meta, standard_metadata);
            process_tunnel_encap.apply(hdr, meta, standard_metadata);
            if (meta.egress_metadata.port_type == 2w0) {
                process_egress_acl.apply(hdr, meta, standard_metadata);
            }
            process_int_outer_encap.apply(hdr, meta, standard_metadata);
            if (meta.egress_metadata.port_type == 2w0) {
                process_vlan_xlate.apply(hdr, meta, standard_metadata);
            }
            process_egress_filter.apply(hdr, meta, standard_metadata);
        }
        if (meta.egress_metadata.port_type == 2w0) {
            process_egress_system_acl.apply(hdr, meta, standard_metadata);
        }
    }
}
...
control process_validate_outer_header(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    apply {
        switch (validate_outer_ethernet.apply().action_run) {
            default: {
                if (hdr.ipv4.isValid()) {
                    validate_outer_ipv4_header.apply(hdr, meta, standard_metadata);
                }
                else {
                    if (hdr.ipv6.isValid()) {
                        validate_outer_ipv6_header.apply(hdr, meta, standard_metadata);
                    }
                    else {
                        if (hdr.mpls[0].isValid()) {
                            validate_mpls_header.apply(hdr, meta, standard_metadata);
                        }
                    }
                }
            }
...
control process_outer_multicast(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    apply {
        if (hdr.ipv4.isValid()) {
            process_outer_ipv4_multicast.apply(hdr, meta, standard_metadata);
        }
        else {
            if (hdr.ipv6.isValid()) {
                process_outer_ipv6_multicast.apply(hdr, meta, standard_metadata);
            }
        }
        process_outer_multicast_rpf.apply(hdr, meta, standard_metadata);
    }
}
...
control process_tunnel(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    apply {
        process_ingress_fabric.apply(hdr, meta, standard_metadata);
                ...
                default: {
                    if (hdr.ipv4.isValid()) {
                        ...
                        if (hdr.ipv6.isValid()) {
                            ...
                            if (hdr.mpls[0].isValid()) {
                                process_mpls.apply(hdr, meta, standard_metadata);
                            }
                        }
                    }
                }
                on_miss: {
                    process_outer_multicast.apply(hdr, meta, standard_metadata);
                }
            }
...
control process_multicast(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    apply {
        if (meta.l3_metadata.lkp_ip_type == 2w1) {
            process_ipv4_multicast.apply(hdr, meta, standard_metadata);
        }
        else {
            if (meta.l3_metadata.lkp_ip_type == 2w2) {
                process_ipv6_multicast.apply(hdr, meta, standard_metadata);
            }
        }
        process_multicast_rpf.apply(hdr, meta, standard_metadata);
    }
}
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    apply {
        process_ingress_port_mapping.apply(hdr, meta, standard_metadata);
        process_validate_outer_header.apply(hdr, meta, standard_metadata);
        process_global_params.apply(hdr, meta, standard_metadata);
        process_port_vlan_mapping.apply(hdr, meta, standard_metadata);
        process_spanning_tree.apply(hdr, meta, standard_metadata);
        process_ingress_qos_map.apply(hdr, meta, standard_metadata);
        process_ip_sourceguard.apply(hdr, meta, standard_metadata);
        process_int_endpoint.apply(hdr, meta, standard_metadata);
        process_ingress_sflow.apply(hdr, meta, standard_metadata);
        process_tunnel.apply(hdr, meta, standard_metadata);
        process_storm_control.apply(hdr, meta, standard_metadata);
        if (meta.ingress_metadata.port_type != 2w1) {
            if (!(hdr.mpls[0].isValid() && meta.l3_metadata.fib_hit == 1w1)) {
                process_validate_packet.apply(hdr, meta, standard_metadata);
                process_ingress_l4port.apply(hdr, meta, standard_metadata);
                process_mac.apply(hdr, meta, standard_metadata);
                if (meta.l3_metadata.lkp_ip_type == 2w0) {
                    process_mac_acl.apply(hdr, meta, standard_metadata);
                }
                else {
                    process_ip_acl.apply(hdr, meta, standard_metadata);
                }
                    ...
                    default: {
                        if ((meta.ingress_metadata.bypass_lookups & 16w0x2) == 16w0) {
                            if (meta.l3_metadata.lkp_ip_type == 2w1 && meta.ipv4_metadata.ipv4_unicast_enabled == 1w1) {
                                process_ipv4_racl.apply(hdr, meta, standard_metadata);
                                process_ipv4_urpf.apply(hdr, meta, standard_metadata);
                                process_ipv4_fib.apply(hdr, meta, standard_metadata);
                            }
                            else {
                                if (meta.l3_metadata.lkp_ip_type == 2w2 && meta.ipv6_metadata.ipv6_unicast_enabled == 1w1) {
                                    process_ipv6_racl.apply(hdr, meta, standard_metadata);
                                    process_ipv6_urpf.apply(hdr, meta, standard_metadata);
                                    process_ipv6_fib.apply(hdr, meta, standard_metadata);
                                }
                            }
                            process_urpf_bd.apply(hdr, meta, standard_metadata);
                        }
                    }
                    rmac_miss: {
                        process_multicast.apply(hdr, meta, standard_metadata);
                    }
                }

                process_ingress_nat.apply(hdr, meta, standard_metadata);
            }
        }
        process_meter_index.apply(hdr, meta, standard_metadata);
        process_hashes.apply(hdr, meta, standard_metadata);
        process_meter_action.apply(hdr, meta, standard_metadata);
        if (meta.ingress_metadata.port_type != 2w1) {
            process_ingress_bd_stats.apply(hdr, meta, standard_metadata);
            process_ingress_acl_stats.apply(hdr, meta, standard_metadata);
            process_storm_control_stats.apply(hdr, meta, standard_metadata);
            process_fwd_results.apply(hdr, meta, standard_metadata);
            process_nexthop.apply(hdr, meta, standard_metadata);
            if (meta.ingress_metadata.egress_ifindex == 16w65535) {
                process_multicast_flooding.apply(hdr, meta, standard_metadata);
            }
            else {
                process_lag.apply(hdr, meta, standard_metadata);
            }
            process_mac_learning.apply(hdr, meta, standard_metadata);
        }
        process_fabric_lag.apply(hdr, meta, standard_metadata);
        process_traffic_class.apply(hdr, meta, standard_metadata);
        if (meta.ingress_metadata.port_type != 2w1) {
            process_system_acl.apply(hdr, meta, standard_metadata);
        }
    }
}
...
control verifyChecksum(in headers hdr, inout metadata meta){
    ...
    apply {
        verify_checksum(hdr.ipv4.ihl == 4w5, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr }, hdr.ipv4.hdrChecksum, HashAlgorithm.crc16);
        verify_checksum(hdr.inner_ipv4.ihl == 4w5, { hdr.inner_ipv4.version, hdr.inner_ipv4.ihl, hdr.inner_ipv4.diffserv, hdr.inner_ipv4.totalLen, hdr.inner_ipv4.identification, hdr.inner_ipv4.flags, hdr.inner_ipv4.fragOffset, hdr.inner_ipv4.ttl, hdr.inner_ipv4.protocol, hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr }, hdr.inner_ipv4.hdrChecksum, HashAlgorithm.crc16);
    }
}

control computeChecksum(inout headers hdr, inout metadata meta){
    apply {
        update_checksum(hdr.ipv4.ihl == 4w5, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr }, hdr.ipv4.hdrChecksum, HashAlgorithm.crc16);
        update_checksum(hdr.inner_ipv4.ihl == 4w5, { hdr.inner_ipv4.version, hdr.inner_ipv4.ihl, hdr.inner_ipv4.diffserv, hdr.inner_ipv4.totalLen, hdr.inner_ipv4.identification, hdr.inner_ipv4.flags, hdr.inner_ipv4.fragOffset, hdr.inner_ipv4.ttl, hdr.inner_ipv4.protocol, hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr }, hdr.inner_ipv4.hdrChecksum, HashAlgorithm.crc16);
    }
