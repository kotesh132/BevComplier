...
@Data
public class CGenCLIParser {

    private static final Logger L = LoggerFactory.getLogger(CGenCLIParser.class);
    @Parameter()
    ...
    public CGenCLIParser(String path) throws InvalidOptionException {
    ...
    public static void main(String[] args) {
        CGenCLIParser clp = new CGenCLIParser(new File("./").getAbsolutePath());
        try{
