...
public class CppGenRunner {
    private static final Logger L = LoggerFactory.getLogger(P416Runner.class);
    private static JCommander commander = null;
    private static CGenCLIParser commandLineParser = new CGenCLIParser(new File("./").getAbsolutePath());
    ...
    private static void runGenerateC(String[] args, boolean systemExitOnException) {
        ...
        try {
            ...
            CppGenRunnerSession cGenRunnerSession = new CppGenRunnerSession(commandLineParser);
