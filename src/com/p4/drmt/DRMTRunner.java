...
public class DRMTRunner {
	private static final Logger L = LoggerFactory.getLogger(DRMTRunner.class);
	...
	public static void main(String[] args) {		
		...
		DRMTRunnerSession gr = new DRMTRunnerSession(cp);
		//gr.initializeSOMModel();
		gr.run12(); //generate keygen and alu configs
		gr.generateIlpSchedule();
		gr.generateSOMConfigs(); //generates SOM config and packets
