...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("parse_ipv6") state parse_ipv6 {
	    ...
	    8w0x0:   parse_ipv6ext_hopbyhop;
    	    8w0x2b:    parse_ipv6ext_routing;
            8w0x6: parse_tcp;
            8w0x11: parse_udp;
            default: accept;
        }
    }
    @name("parse_ipv6ext_hopbyhop") state parse_ipv6ext_hopbyhop {
        packet.extract(hdr.ipv6ext.next.hopbyhop,
            (bit<32>) (8 * (packet.lookahead<ipv6exhdr_up_to_hdrextlen_only_t>().hdrExtLen) + 8 ));
        transition select (hdr.ipv6ext.last.hopbyhop.nextHdr) {
            8w0x0:   parse_ipv6ext_hopbyhop;
    	    8w0x2b:  parse_ipv6ext_routing;
            8w0x6: parse_tcp;
            8w0x11: parse_udp;
    ...
    @name("parse_ipv6ext_routing") state parse_ipv6ext_routing {
        packet.extract(hdr.ipv6ext.next.routing,
            (bit<32>) (8 * (packet.lookahead<ipv6exhdr_up_to_hdrextlen_only_t>().hdrExtLen) + 8));
        transition select (hdr.ipv6ext.last.routing.nextHdr) {
            8w0x0:   parse_ipv6ext_hopbyhop;
    	    8w0x2b:    parse_ipv6ext_routing;
            8w0x6: parse_tcp;
            8w0x11: parse_udp;
